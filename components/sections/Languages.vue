<script setup>
  const logos = [
    'https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/Logo.min.svg/1280px-Logo.min.svg.png',
    'https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Vue.js_Logo_2.svg/1184px-Vue.js_Logo_2.svg.png',
    'https://upload.wikimedia.org/wikipedia/de/d/dd/MySQL_logo.svg',
    'https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/PHP-logo.svg/711px-PHP-logo.svg.png?20180502235434',
    'https://upload.wikimedia.org/wikipedia/commons/7/70/Docker_logo.png',
    'https://www.xpand-it.com/wp-content/uploads/2018/09/React-Logo.png',
    'https://seeklogo.com/images/N/nuxt-logo-5EF50E1ABD-seeklogo.com.png',
    ...
    'https://marketplacedesignoye.s3.ap-south-1.amazonaws.com/postgresql-branding-icon-symbol-logo-vector-.png',
    'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ee/Redis_logo.svg/2560px-Redis_logo.svg.png',
...
<template>
  <Vue3Marquee>
    <img v-for="logo in logos" :src="logo" alt="Logo 1" class="mx-4 h-12" />
  </Vue3Marquee>
</template>
